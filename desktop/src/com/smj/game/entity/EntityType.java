...
public enum EntityType {
    ...
    BUZZY_BEETLE(new InstanceBuilder<>(WalkingTextureProvider.class, get(Gdx.files.internal("assets/images/entities/buzzy_beetle.png")), 2), new Dimension(100, 100), new InstanceBuilder<>(StompableBehavior.class, EntityType.BUZZY_BEETLE_SHELL), new InstanceBuilder<>(WalkingBehavior.class, 0.087890625), new InstanceBuilder<>(FireballInvulnerableBehavior.class), new InstanceBuilder<>(IceballVulnerableBehavior.class), new InstanceBuilder<>(ShellVulnerableBehavior.class), new InstanceBuilder<>(WindBehavior.class), new InstanceBuilder<>(CoinDeathRewardBehavior.class)),
    PIRANHA_PLANT(new InstanceBuilder<>(AnimatedTextureProvider.class, get(Gdx.files.internal("assets/images/entities/piranha_plant.png")), 2), new Dimension(100, 150), new EntityProperties().setDrawInBG(true), new InstanceBuilder<>(PiranhaPlantBehavior.class), new InstanceBuilder<>(HarmfulBehavior.class), new InstanceBuilder<>(FireballVulnerableBehavior.class), new InstanceBuilder<>(IceballVulnerableBehavior.class), new InstanceBuilder<>(ShellVulnerableBehavior.class), new InstanceBuilder<>(CoinDeathRewardBehavior.class)),
    ...
    BLOOPER(new InstanceBuilder<>(AnimatedTextureProvider.class, get(Gdx.files.internal("assets/images/entities/blooper.png")), 2), new Dimension(100, 100), new InstanceBuilder<>(BlooperBehavior.class), new InstanceBuilder<>(HarmfulBehavior.class), new InstanceBuilder<>(FireballVulnerableBehavior.class), new InstanceBuilder<>(IceballVulnerableBehavior.class), new InstanceBuilder<>(ShellVulnerableBehavior.class), new InstanceBuilder<>(WindBehavior.class), new InstanceBuilder<>(CoinDeathRewardBehavior.class)),
    PODOBOO(new InstanceBuilder<>(PodobooTextureProvider.class, get(Gdx.files.internal("assets/images/entities/podoboo.png"))), new Dimension(100, 100), new EntityProperties().setImmuneToFluid(true), new InstanceBuilder<>(PodobooBehavior.class), new InstanceBuilder<>(HarmfulBehavior.class), new InstanceBuilder<>(IceballVulnerableBehavior.class), new InstanceBuilder<>(ShellVulnerableBehavior.class), new InstanceBuilder<>(FireballInvulnerableBehavior.class), new InstanceBuilder<>(CoinDeathRewardBehavior.class)),
    ...
    ICE_CUBE(new InstanceBuilder<>(StaticTextureProvider.class, get(Gdx.files.internal("assets/images/entities/ice_cube.png"))), new Dimension(100, 100), new InstanceBuilder<>(SolidHitboxBehavior.class), new InstanceBuilder<>(FireballMeltingBehavior.class)),
    ...
    BRICK(new InstanceBuilder<>(RotatingTextureProvider.class, get(Gdx.files.internal("assets/images/entities/brick.png"))), new Dimension(50, 50), new EntityProperties().setImmuneToFluid(true), new InstanceBuilder<>(BrickBehavior.class), new InstanceBuilder<>(WindBehavior.class)),

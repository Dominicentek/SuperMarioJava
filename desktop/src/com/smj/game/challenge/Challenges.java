...
public class Challenges {
    ...
    public static final Challenge SUPERSTAR_SPEEDRUN = add("superstar_speedrun", new Challenge().medals(new Medals(38 * 60, 41 * 60, 45 * 60).comparator(Medals.LESS_THAN)).difficulty(2).level(101).timer(45).event(new TimerChallengeEvent()).type(ChallengeType.TIME));
    public static final Challenge DEDICATED_LEVEL_SPEEDRUN = add("dedicated_level_speedrun", new Challenge().medals(new Medals(30 * 60, 33 * 60, 36 * 60).comparator(Medals.LESS_THAN)).difficulty(3).level(100).timer(36).event(new TimerChallengeEvent()).type(ChallengeType.TIME));
    ...
    public static final Challenge MANY_COINS = add("many_coins", new Challenge().medals(new Medals(160, 150, 130).comparator(Medals.GREATER_THAN)).difficulty(2).level(102).timer(30).event(new TimedCoinsChallengeEvent()).type(ChallengeType.COIN));
    ...
    public static final Challenge SNOW_JUMPS = add("snow_jumps", new Challenge().medals(new Medals(15, 16, 17).comparator(Medals.LESS_THAN)).difficulty(1).level(17).timer(120).event(new JumpChallengeEvent()).type(ChallengeType.JUMP));
    public static final Challenge FOREST_JUMPS = add("forest_jumps", new Challenge().medals(new Medals(21, 22, 23).comparator(Medals.LESS_THAN)).difficulty(2).level(27).timer(120).event(new JumpChallengeEvent()).type(ChallengeType.JUMP));
    ...
    public static final Challenge GOOMBA_STOMP = add("goomba_stomp", new Challenge().medals(new Medals(10 * 60 + 30, 13 * 60, 16 * 60)).difficulty(2).level(102).timer(16).event(new EnemyKillChallengeEvent(14)).type(ChallengeType.MISC));

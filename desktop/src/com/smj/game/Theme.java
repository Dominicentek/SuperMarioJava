...
public class Theme {
    ...
    public Theme(Texture tileset, LevelBackground background) {
        ...
        addTile(Tiles.QUESTION_BLOCK_COIN, new ContainerTile(EntityType.COIN, false, false).setSolid(true), tileset, 0x0B, 0x0B, 0x0B, 0x2E, 0x2F, 0x2E);
        addTile(Tiles.QUESTION_BLOCK_MUSHROOM, new MushroomContainerTile(false).setSolid(true), tileset, 0x0B, 0x0B, 0x0B, 0x2E, 0x2F, 0x2E);
        addTile(Tiles.QUESTION_BLOCK_FIRE_FLOWER, new ContainerTile(EntityType.FIRE_FLOWER, true, false).setSolid(true), tileset, 0x0B, 0x0B, 0x0B, 0x2E, 0x2F, 0x2E);
        addTile(Tiles.QUESTION_BLOCK_ICE_FLOWER, new ContainerTile(EntityType.ICE_FLOWER, true, false).setSolid(true), tileset, 0x0B, 0x0B, 0x0B, 0x2E, 0x2F, 0x2E);
        addTile(Tiles.QUESTION_BLOCK_JUMP_SHOES, new ContainerTile(EntityType.JUMP_SHOES, true, false).setSolid(true), tileset, 0x0B, 0x0B, 0x0B, 0x2E, 0x2F, 0x2E);
        addTile(Tiles.QUESTION_BLOCK_SPEED_SHOES, new ContainerTile(EntityType.SPEED_SHOES, true, false).setSolid(true), tileset, 0x0B, 0x0B, 0x0B, 0x2E, 0x2F, 0x2E);
        addTile(Tiles.QUESTION_BLOCK_1UP, new ContainerTile(EntityType.LIFE_MUSHROOM, false, false).setSolid(true), tileset, 0x0B, 0x0B, 0x0B, 0x2E, 0x2F, 0x2E);
        addTile(Tiles.QUESTION_BLOCK_POISON_MUSHROOM, new ContainerTile(EntityType.POISONOUS_MUSHROOM, false, false).setSolid(true), tileset, 0x0B, 0x0B, 0x0B, 0x2E, 0x2F, 0x2E);
        addTile(Tiles.QUESTION_BLOCK_SUPERSTAR, new ContainerTile(EntityType.SUPERSTAR, false, false).setSolid(true), tileset, 0x0B, 0x0B, 0x0B, 0x2E, 0x2F, 0x2E);
        addTile(Tiles.BRICK_EMPTY, new BrickTile(true).setSolid(true), tileset, 0x0C);
        addTile(Tiles.BRICK_COIN, new ContainerTile(EntityType.COIN, false, false).setSolid(true), tileset, 0x0C);
        addTile(Tiles.BRICK_MUSHROOM, new MushroomContainerTile(false).setSolid(true), tileset, 0x0C);
        addTile(Tiles.BRICK_FIRE_FLOWER, new ContainerTile(EntityType.FIRE_FLOWER, true, false).setSolid(true), tileset, 0x0C);
        addTile(Tiles.BRICK_ICE_FLOWER, new ContainerTile(EntityType.ICE_FLOWER, true, false).setSolid(true), tileset, 0x0C);
        addTile(Tiles.BRICK_JUMP_SHOES, new ContainerTile(EntityType.JUMP_SHOES, true, false).setSolid(true), tileset, 0x0C);
        addTile(Tiles.BRICK_SPEED_SHOES, new ContainerTile(EntityType.SPEED_SHOES, true, false).setSolid(true), tileset, 0x0C);
        addTile(Tiles.BRICK_1UP, new ContainerTile(EntityType.LIFE_MUSHROOM, false, false).setSolid(true), tileset, 0x0C);
        addTile(Tiles.BRICK_POISON_MUSHROOM, new ContainerTile(EntityType.POISONOUS_MUSHROOM, false, false).setSolid(true), tileset, 0x0C);
        addTile(Tiles.BRICK_SUPERSTAR, new ContainerTile(EntityType.SUPERSTAR, false, false).setSolid(true), tileset, 0x0C);
        addTile(Tiles.FRAGILE_BRICK, new BrickTile(false).setSolid(true), tileset, 0x0C);
        addTile(Tiles.INVISIBLE_QUESTION_BLOCK_COIN, new ContainerTile(EntityType.COIN, false, true), tileset, 0x00);
        addTile(Tiles.INVISIBLE_QUESTION_BLOCK_MUSHROOM, new MushroomContainerTile(true), tileset, 0x00);
        addTile(Tiles.INVISIBLE_QUESTION_BLOCK_FIRE_FLOWER, new ContainerTile(EntityType.FIRE_FLOWER, true, true), tileset, 0x00);
        addTile(Tiles.INVISIBLE_QUESTION_BLOCK_ICE_FLOWER, new ContainerTile(EntityType.ICE_FLOWER, true, true), tileset, 0x00);
        addTile(Tiles.INVISIBLE_QUESTION_BLOCK_JUMP_SHOES, new ContainerTile(EntityType.JUMP_SHOES, true, true), tileset, 0x00);
        addTile(Tiles.INVISIBLE_QUESTION_BLOCK_SPEED_SHOES, new ContainerTile(EntityType.SPEED_SHOES, true, true), tileset, 0x00);
        addTile(Tiles.INVISIBLE_QUESTION_BLOCK_1UP, new ContainerTile(EntityType.LIFE_MUSHROOM, false, true), tileset, 0x00);
        addTile(Tiles.INVISIBLE_QUESTION_BLOCK_POISON_MUSHROOM, new ContainerTile(EntityType.POISONOUS_MUSHROOM, false, true), tileset, 0x00);
        addTile(Tiles.INVISIBLE_QUESTION_BLOCK_SUPERSTAR, new ContainerTile(EntityType.SUPERSTAR, false, true), tileset, 0x00);
        ...
        */
        ...
        addTile(Tiles.MOVING_BLOCK, new EntitySpawnerTile(EntityType.MOVING_BLOCK), tileset, 0x00);
    }
